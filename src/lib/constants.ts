...
> = {
  fire: { fire: "neutral", ice: "advantage", thunder: "disadvantage" },
  ice: { ice: "neutral", thunder: "advantage", fire: "disadvantage" },
  thunder: { thunder: "neutral", fire: "advantage", ice: "disadvantage" },
};
...
export const AREAS: readonly AreaConfig[] = [
  {
    ...
    rewardMultiplier: 1,
    elementDistribution: { fire: 0.33, ice: 0.33, thunder: 0.34 },
    abnormalRate: 0.0005,
    bossMultiplier: 2,
  ...
  },
  {
    ...
    elementDistribution: { fire: 0.3, ice: 0.3, thunder: 0.4 },
    abnormalRate: 0.001,
    bossMultiplier: 2.5,
  ...
  },
  {
    ...
    rewardMultiplier: 3,
    elementDistribution: { fire: 0.2, ice: 0.2, thunder: 0.6 },
    abnormalRate: 0.002,
    bossMultiplier: 3,
  ...
  },
  {
    ...
    rewardMultiplier: 6,
    elementDistribution: { fire: 0.2, ice: 0.5, thunder: 0.3 },
    abnormalRate: 0.004,
    bossMultiplier: 3.5,
  ...
  },
  {
    ...
    rewardMultiplier: 12,
    elementDistribution: { fire: 0.15, ice: 0.55, thunder: 0.3 },
    abnormalRate: 0.007,
    bossMultiplier: 4,
  ...
  },
  {
    ...
    rewardMultiplier: 25,
    elementDistribution: { fire: 0.6, ice: 0.15, thunder: 0.25 },
    abnormalRate: 0.01,
    bossMultiplier: 5,
  ...
  },
  {
    ...
    rewardMultiplier: 60,
    elementDistribution: { fire: 0.35, ice: 0.35, thunder: 0.3 },
    abnormalRate: 0.014,
    bossMultiplier: 6,
