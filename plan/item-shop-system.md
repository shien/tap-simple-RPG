...
| # | アイテム名 | 効果 | 使用タイミング |
|---|-----------|------|--------------|
| 1 | 属性変更の巻物 | 武器の属性を選択した属性に変更（戦闘終了まで一時的） | 戦闘中 |
| 2 | 完全防御の盾 | 次の敵攻撃のダメージを完全に0にする | 戦闘中 |
...
|---------|-----------|-------------|-------------|
| 属性変更の巻物 | ×3 | 90G | 12,000,000,000G |
| 完全防御の盾 | ×5 | 150G | 20,000,000,000G |
